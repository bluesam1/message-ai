...
export class ContextAnalysisService {
  ...
  async analyzeContext(
    ...
    try {
      ...
      console.error('[ContextAnalysisService] Error in AI context analysis:', error);
      throw error;
    }
  }
  ...
  private async performAIAnalysis(
    ...
    try {
      console.log(`[ContextAnalysisService] Starting AI analysis for ${messages.length} messages`);
      ...
      if (conversationSettings.autoTranslate) {
        try {
          ...
          console.warn('[ContextAnalysisService] Could not get user preferred language:', error);
        }
      }
  ...
  "relevanceScores": [
    {
      ...
      console.log('[ContextAnalysisService] Starting AI analysis with prompt length:', systemPrompt.length);
      ...
      try {
        ...
        console.error('[ContextAnalysisService] Failed to parse AI response:', parseError);
        throw new Error('Failed to parse AI analysis result');
      }
    } catch (error) {
      console.error('[ContextAnalysisService] Error in AI analysis:', error);
